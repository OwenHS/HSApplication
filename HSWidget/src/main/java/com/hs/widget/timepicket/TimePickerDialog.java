...
import com.hs.widget.timepicket.data.Type;
import com.hs.widget.timepicket.data.WheelCalendar;
import com.hs.widget.timepicket.listener.OnDateSetListener;
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.tv_cancel) {
            if(mPickerConfig.mCallBack != null){
                mPickerConfig.mCallBack.onCancel(this);
            }
            dismiss();
