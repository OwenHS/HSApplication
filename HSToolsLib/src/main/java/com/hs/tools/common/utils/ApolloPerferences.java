...
/**
 * sharePerference的封装类
 * Created by huangshuo on 16/9/13.
 */
public class ApolloPerferences {

    protected SharedPreferences sp;

    private ApolloPerferences(String name,Context context){
     ...
     * @return
     */
    public static ApolloPerferences create(String name, Context context){
        ApolloPerferences ppsp = new ApolloPerferences(name,context);
        return ppsp;
    }
     ...
     * @return
     */
    public static ApolloPerferences createDefault(Context context){
        String name = context.getPackageName().replaceAll(".", "_");
        ApolloPerferences ppsp = create(name,context);
        return ppsp;
    }

    public final ApolloPerferences putString(String key,String value){
        value = value == null ? "":value;
        sp.edit().putString(key, value).commit();
        return this;
    }

    public final ApolloPerferences putStringSet(String key,Set<String> values){
        sp.edit().putStringSet(key, values);
        return this;
    }

    public final ApolloPerferences putInteger(String key,int value){
        sp.edit().putInt(key, value).commit();
        return this;
    }

    public final ApolloPerferences putBoolean(String key, boolean value){
        sp.edit().putBoolean(key, value).commit();
        return this;
    }

    public final ApolloPerferences putFloat(String key, float value){
        sp.edit().putFloat(key, value).commit();
        return this;
    }

    public final ApolloPerferences putLong(String key, long value){
