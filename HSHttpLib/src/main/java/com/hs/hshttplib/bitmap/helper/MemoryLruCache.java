...
/**********************************************************
 * @文件名称：MemoryLruCache.java
 * @文件作者：Administrator
 * @创建时间：2015-6-5 下午1:39:16
 * @文件描述：经过Least Recently Used（最近最少使用）算法处理的LinkedHashMap<br>
 * @修改历史：2015-6-5创建初始版本
 **********************************************************/
...
public class MemoryLruCache<K, V> {
    ...
    public final V get(K key) {
		...
		/*
         * 尝试创建一个value This may take a long time, and the map may be different when create() returns. If a conflicting
		 * value was added to the map while create() was working, we leave that value in the map and release the created
		 * value.
		 */
