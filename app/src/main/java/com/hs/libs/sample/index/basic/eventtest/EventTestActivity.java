 ...
 */
@ViewInject(id = R.layout.layout_event_main)
public class EventTestActivity extends HSModulesBaseActivity {
    ...
    public void initData() {
        super.initData();
        titleView.setTitle("事件分发").setOnLeftClick(new View.OnClickListener() {
            @Override
...
//        findViewById(R.id.childs2).setClickable(false);
    ...
    private void setViewListener(final View view, final String viewName) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TouchEventUtil.logActionMsg(EventTestActivity.class, viewName + " setOnClickListener  onClick", null);
            }
        });
        view.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                TouchEventUtil.logActionMsg(EventTestActivity.class, viewName + " setOnTouchListener  onTouch", event);
                return false;
            }
        });
    }
...
//        setViewListener(findViewById(R.id.allRl), "OutPlant");
     ...
     * 1.2   Father  点击，  （EventTestActivity）dispatchTouchEvent，（TouchEventFather）dispatchTouchEvent，（TouchEventFather）onInterceptTouchEvent，（TouchEventFather）onTouchEvent，（EventTestActivity）onTouchEvent，
